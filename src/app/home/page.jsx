...
//     return (
//         <div className="min-h-screen flex flex-col md:flex-row items-center justify-center px-4 md:px-8 py-20 bg-black">
//             <motion.div
...
//                 >
//                     MERN Stack & Next.js Developer with expertise in building responsive and
//                     dynamic web applications. BSCS graduate from UCP.
//                 </motion.p>
//                 <motion.button
...
//             >
//                 <motion.div
//                     className="relative w-80 h-80 ml-16 md:w-96 md:h-96"
//                     animate="animate"
//                     variants={glowAnimation}
//                 >
//                     <div className="absolute inset-0 rounded-full bg-[#FFD700] opacity-10 blur-2xl" />
//                     <motion.div
//                         className="relative ml-10  overflow-hidden"
//                         whileHover={{ scale: 1.05 }}
...
//                             width={300}
//                             height={300}
//                             className="object-cover md:mt-0"
//                         />
//                     </motion.div>
